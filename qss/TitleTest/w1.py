...
class TitleWidget(QWidget):
    def __init__(self):
        ...
        titleIcon = QPixmap("./MyTitle_Image/icon.png")
        Icon = QLabel()
        ...
        Qss = '''
            ...
            {
                border-image:url(./MyTitle_Image/min.png) 0 81 0 0 ;

            }

            QPushButton#ButtonMin:hover
            {
                border-image:url(./MyTitle_Image/min.png) 0 54 0 27 ;
            }

            QPushButton#ButtonMin:pressed
            {
                border-image:url(./MyTitle_Image/min.png) 0 27 0 54 ;
            }

            QPushButton#ButtonMax
            {
                border-image:url(./MyTitle_Image/max.png) 0 81 0 0 ;
            }

            QPushButton#ButtonMax:hover
            {
                border-image:url(./MyTitle_Image/max.png) 0 54 0 27 ;
            }

            QPushButton#ButtonMax:pressed
            {
                border-image:url(./MyTitle_Image/max.png) 0 27 0 54 ;
            }

            QPushButton#ButtonRestore
            {
                border-image:url(./MyTitle_Image/restore.png) 0 81 0 0 ;
            }

            QPushButton#ButtonRestore:hover
            {
                border-image:url(./MyTitle_Image/restore.png) 0 54 0 27 ;
            }

            QPushButton#ButtonRestore:pressed
            {
                border-image:url(./MyTitle_Image/restore.png) 0 27 0 54 ;
            }

            QPushButton#ButtonClose
            {
                border-image:url(./MyTitle_Image/close.png) 0 81 0 0 ;
                border-top-right-radius:3 ;
            }

            QPushButton#ButtonClose:hover
            {
                border-image:url(./MyTitle_Image/close.png) 0 54 0 27 ;
                border-top-right-radius:3 ;
            }

            QPushButton#ButtonClose:pressed
            {
                border-image:url(./MyTitle_Image/close.png) 0 27 0 54 ;
                border-top-right-radius:3 ;
            }
